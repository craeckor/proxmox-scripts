...
```bash
bash -c "$(wget --no-cache -qO- https://raw.githubusercontent.com/craeckor/proxmox-scripts/main/create.sh)"
```
...
```bash
bash -c "$(wget --no-cache -qO- https://raw.githubusercontent.com/craeckor/proxmox-scripts/main/create.sh)" -s --app nginx-proxy-manager --cleanup
```
...
[Nginx Proxy Manager](https://github.com/craeckor/proxmox-scripts/tree/main/apps/nginx-proxy-manager)
